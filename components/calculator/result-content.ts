...
export const RESULT_COPY: Record<ReasonKey, ResultCopy & { pillar: Pillar }> = {
  ...
  'sem-crm': {
    pillar: 'implementacao-automacao',
    headline: 'Dá pra economizar bastante aqui, mas o começo é o CRM.',
    message:
  ...
  'dados-espalhados': {
    ...
    headline: 'O potencial existe, mas vale organizar os dados antes.',
    message:
  ...
  inicial: {
    ...
    message:
      'Seu cenário ainda é enxuto para um projeto completo de automação, e tudo bem. Soluções prontas (bots e no-code) já entregam valor em poucos dias.',
